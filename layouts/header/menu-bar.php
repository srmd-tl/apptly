...
<div class="els-menubar <?php echo esc_attr($elsey_menubar_position_class); ?>" style="<?php echo esc_attr($elsey_menubar_bg); ?>">
  <div class="container">
    <div class="row">
      ...
      <div class="els-logo col-lg-2 col-md-2 col-5" style="<?php echo esc_attr($elsey_logo_style); ?>">
      ...
      <div class="els-main-menu col-lg-8 col-md-8 col-12" style="<?php echo esc_attr($elsey_menubar_position_css); ?>">
        <?php
        wp_nav_menu(
          array(
            'menu'           => 'primary',
      ...
      <div class="els-icon col-lg-2 col-md-2 col-7">         
      <ul id="top_access">
          <?php
            if ( !is_user_logged_in() ) {
               ?>
                <li>
                  <a href="<?php echo home_url(); ?>/customer-registration/" class="btn_1">
                    <!-- <img src="<?php echo get_template_directory_uri(); ?>/images/register.png" alt=""> -->
                    Register
                  </a>
                </li>
                <li>
                  <a href="<?php echo home_url(); ?>/my-account" class="btn_1">
            ...
            else if(is_user_logged_in() && $user->roles[0] == 'Doctors') {
              $getImageUrl = get_the_author_meta('user_registration_profile_pic_url' , get_current_user_id());
                if(!$getImageUrl)
                {
                  $getImageUrl = get_template_directory_uri() . "/images/login.png";
                }
                ?>
                ...
                <li data-toggle="dropdown">
                  ...
                  My Account &nbsp;&nbsp;<i class="fa fa-angle-down"></i>
                    <!-- <img src="<?php echo $getImageUrl; ?>" alt="" class="<?php if(get_the_author_meta('user_registration_profile_pic_url' , get_current_user_id())) { echo "userImage"; } ?>"> -->
                  </a>
                </li>

          
                <div class="dropdown-menu dropdown-menu-right mt-4" aria-labelledby="dropdownMenuButton">
                  <a class="dropdown-item" href="<?php echo home_url(); ?>/my-account">My Account</a>
                  <a class="dropdown-item" href="<?php echo home_url(); ?>/your-leads">Total Leads</a>
                  <!-- <a class="dropdown-item" href="<?php echo home_url(); ?>/your-billings">All Billings</a> -->
                  <a class="dropdown-item" href="<?php echo home_url(); ?>/subscription">Subscriptions</a>
                  <a class="dropdown-item" href="<?php echo home_url(); ?>/your-reviews">All Reviews</a>
                  <?php
                  $meta = get_user_meta (get_current_user_id() , 'user_registration_verified_member');
                    if($meta[0] == "No")
                    {
                      ?>
                      <a class="dropdown-item" href="<?php echo home_url(); ?>/become-verify/?speciality=<?php echo get_user_meta (get_current_user_id() , 'user_registration_speciality')[0]?>">Become Verify</a>
                      <?php
                    }
                  ?>
            ...
            else if(is_user_logged_in() && $user->roles[0] == 'Customers')
            {
              ?>
              <li>
                  <a href="<?php echo home_url(); ?>/my-account" class="btn_1">
