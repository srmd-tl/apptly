...
if ($footer_copyright_layout === 'copyright-2') {
  $copyright_layout_class    = 'col-lg-6 col-md-6 col-sm-6 col-12 els-align-left';
  $copyright_seclayout_class = 'col-lg-6 col-md-6 col-sm-6 col-12 els-align-right';
} elseif ($footer_copyright_layout === 'copyright-3') {
  $copyright_layout_class    = 'col-lg-6 col-md-6 col-sm-6 col-12 els-align-right';
  $copyright_seclayout_class = 'col-lg-6 col-md-6 col-sm-6 col-12 els-align-left';
} else {
  $copyright_layout_class    = 'col-lg-12 col-md-12 col-sm-12 col-12 els-align-center';
