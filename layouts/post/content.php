...
if($blog_listing_columns === 'els-blog-col-3') {
  if ($blog_read_more_option && $blog_share_option) {
    $blog_more_col_class  = 'col-lg-5 col-md-12 col-sm-12 col-12';
    $blog_share_col_class = 'col-lg-7 col-md-12 col-sm-12 col-12';
  } else if ($blog_read_more_option || $blog_share_option) {
    $blog_more_col_class  = 'col-lg-12 col-md-12 col-sm-12 col-12';
    $blog_share_col_class = 'col-lg-12 col-md-12 col-sm-12 col-12';
  } else {
    $blog_more_col_class  = 'col-lg-5 col-md-12 col-sm-12 col-12';
    $blog_share_col_class = 'col-lg-7 col-md-12 col-sm-12 col-12';
  }
  ...
  if ($blog_read_more_option && $blog_share_option) {
    $blog_more_col_class  = 'col-lg-5 col-md-5 col-sm-5 col-12';
    $blog_share_col_class = 'col-lg-7 col-md-7 col-sm-7 col-12';
  } else if ($blog_read_more_option || $blog_share_option) {
    $blog_more_col_class  = 'col-lg-12 col-md-12 col-sm-12 col-12';
    $blog_share_col_class = 'col-lg-12 col-md-12 col-sm-12 col-12';
  } else {
