    ...
    <?php if ( have_comments() ) : ?>
    	<div class="comments-section">
    	  ...
    	  <h3 class="comments-title">
	    	<?php
	    		printf( // WPCS: XSS OK.
	    			esc_html__( _nx( '%1$s '.$elsey_sgular_comment_text, '%1$s '.$elsey_plural_comment_text, get_comments_number(), 'comments title', 'elsey' ) ),
  ...
  if ( comments_open() ) { ?>
		<div class="els-comment-form">
		  <?php
			...
			$fields = array(
		    'author' => '<div class="row els-form-inputs"><div class="col-lg-4 col-md-4 col-sm-4 col-12 els-form-input-box"><p><label>'.esc_attr($elsey_name_label_text).'<span>'.esc_html__('*', 'elsey').'</span></label><input type="text" id="author" name="author" value="'.esc_attr($commenter['comment_author']) . '" tabindex="1"/></p></div>',
		    'email' => '<div class="col-lg-4 col-md-4 col-sm-4 col-12 els-form-input-box"><p><label>'.esc_attr($elsey_email_label_text).'<span>'.esc_html__('*', 'elsey').'</span></label><input type="text" id="email" name="email" value="'.esc_attr($commenter['comment_author_email']).'" tabindex="2" /></p></div>',
		    'URL' => '<div class="col-lg-4 col-md-4 col-sm-4 col-12 els-form-input-box"><p><label>'.esc_attr($elsey_url_label_text).'</label><input type="text" id="url" name="url" value="'.esc_attr($commenter['comment_author_url']).'" tabindex="3" /></p></div></div>',
		  );
