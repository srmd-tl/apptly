    ...
    <div class="row">
      <div class="col">
        <ul class="nav nav-pills mb-3" id="pills-tab" role="tablist">
          <li class="nav-item">
            <a class="nav-link active" id="pills-thisMonth-tab" data-toggle="pill" href="#pills-thisMonth" role="tab" aria-controls="pills-thisMonth" aria-selected="false">This Month Billing</a>
          </li>
        </ul>
          ...
          <table id="myTable">
                   <thead>
                        <tr>
                            ...
                            <th>Total Number Of Leads this Month</th>
                   ...
                   <tbody>   
                          ...
                          <tr>
                            <td><?php echo totalNumberOfLeads()?></td>
                            <td>
                              <div class="d-flex align-items-center">
                              <?php echo "<span class='mr-3'>$ ".totalBill()."</span>";
                             echo do_shortcode( '[accept_stripe_payment name="Pay for This Month Bill" price="'.totalBill().'" button_text="Pay Now"]' ); 
